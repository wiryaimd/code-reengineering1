...
public class TextPatterns {
    ...
    private static final Pattern ansiEscapes2 = Pattern.compile("^\\e(?:\\[[0-9;]*m)?");
    ...
    public static Patterb getAnsiEscapes2Pattern() { return ansiEscapes2; }
    ...
    public static char getEscapeChar() { return escapeChar; }
