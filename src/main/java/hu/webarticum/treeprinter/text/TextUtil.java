...
public class TextUtil {
    ...
    public static String[] linesOf(String text) {
        return TextPatterns.getLineSeparatorPattern().split(text);
    }
    ...
    public static String ansiReset() {
        return AnsiTextFormatter.ansiReset();
    }
    
    public static String ansiToPlain(String ansiText) {
        return AnsiTextFormatter.stripAnsi(ansiText);
    }
    
    public static String cleanPlain(String rawPlainText) {
        return TextCleaner.clean(rawPlainText, TextCleaner.CleaningMode.PLAIN);
    }
    
    public static String cleanAnsi(String rawAnsiText) {
        return TextCleaner.clean(rawAnsiText, TextCleaner.CleaningMode.ANSI);
    }

    public static String formatLine(String line, AnsiFormat format) {
        return AnsiTextFormatter.format(line, format);
    }
